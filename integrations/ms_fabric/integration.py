...
class MetadataQueryTemplates:
    ...
    def get_tables_query_template(self) -> str:
        ...
        return (
            ...
            " LOWER(CASE WHEN TABLE_TYPE = 'VIEW' THEN 'view' ELSE 'table' END) AS table_type"
    ...
    def get_columns_query_template(self) -> str:
        ...
        return (
            ...
            " WHERE TABLE_CATALOG + '.' + TABLE_SCHEMA + '.' + TABLE_NAME IN ({{ tables }})"
...
class QueryLogCollectionTemplates:
    ...
    def get_query_logs_query_template(self) -> str:
        ...
        return (
            "SELECT"
            " login_name,"
            " submit_time AS start_time,"
            " end_time,"
            " distributed_statement_id AS query_id,"
            " command AS query_text,"
            " status"
            " FROM queryinsights.exec_requests_history"
            " WHERE submit_time >= '{{ start_time.strftime('%Y-%m-%d %H:%M:%S') }}'"
            " AND submit_time < '{{ end_time.strftime('%Y-%m-%d %H:%M:%S') }}'"
...
class CustomSQLMonitorTemplates:
    ...
    def add_row_limit_template(self) -> str:
        ...
        """
        return "SELECT TOP {{ limit }} * FROM ({{ query }}) AS _row_limited"
...
class QueryLanguageTemplates:
    ...
    def negate_expression_template(self) -> str:
        ...
        """
        return "{% if expression == 'TRUE' %}1 = 0{% elif expression == 'FALSE' %}1 = 1{% else %}NOT {{ expression }}{% endif %}"
    ...
    def literal_datetime_template(self) -> str:
        ...
        """
        return "CONVERT(DATETIME2, '{{ value.strftime('%Y-%m-%d %H:%M:%S') }}')"
    ...
    def literal_table_from_value_list_template(self) -> str:
        ...
        """
        return "SELECT val AS value FROM (VALUES ({{ values | join('), (') }})) AS t(val)"
    ...
    def date_literal_template(self) -> str:
        ...
        """
        return "CONVERT(DATE, '{{ value.strftime('%Y-%m-%d') }}')"
    ...
    def utc_literal_template(self) -> str:
        ...
        """
        return "{% if value is defined %}TODATETIMEOFFSET(CONVERT(DATETIME2, '{{ value.strftime('%Y-%m-%d %H:%M:%S') }}'), '+00:00'){% else %}SYSDATETIMEOFFSET(){% endif %}"
    ...
    def get_casting_to_decimal_expression_template(self) -> str:
        ...
        Enables: sum metric
        """
        return "CAST({{ field }} AS DECIMAL(38, 10))"
    ...
    def cast_string_to_timestamp_template(self) -> str:
        ...
        """
        return "TRY_CAST({{ field }} AS DATETIME2)"
    ...
    def cast_numeric_to_timestamp_template(self) -> str:
        ...
        """
        return "DATEADD(SECOND, {{ field }}, CAST('1970-01-01' AS DATETIME2))"
    ...
    def cast_timestamp_to_timestamp_tz_template(self) -> str:
        ...
        """
        return "CAST({{ field }} AS DATETIMEOFFSET)"
    ...
    def convert_to_utc_template(self) -> str:
        ...
        """
        return "SWITCHOFFSET(CAST({{ field }} AS DATETIMEOFFSET), '+00:00')"
    ...
    def add_hours_timestamp_func_template(self) -> str:
        ...
        """
        return "DATEADD(hour, {{ hours }}, {{ field }})"
    ...
    def get_is_yesterday_expression_template(self) -> str:
        ...
        """
        return "CAST({{ field }} AS DATE) = DATEADD(day, -1, CAST(GETUTCDATE() AS DATE))"
    ...
    def get_in_past_days_expression_template(self) -> str:
        ...
        """
        return "{{ field }} >= DATEADD(day, -{{ days }}, GETUTCDATE())"
    ...
    def get_in_past_hours_expression_template(self) -> str:
        ...
        """
        return "{{ field }} >= DATEADD(hour, -{{ hours }}, GETUTCDATE())"
    ...
    def get_in_past_calendar_week_expression_template(self) -> str:
        ...
        """
        return "DATETRUNC(week, CAST({{ field }} AS DATE)) = DATETRUNC(week, CAST(GETUTCDATE() AS DATE))"
    ...
    def get_in_past_calendar_month_expression_template(self) -> str:
        ...
        """
        return "DATETRUNC(month, CAST({{ field }} AS DATE)) = DATETRUNC(month, CAST(GETUTCDATE() AS DATE))"
    ...
    def get_date_diff_func_template(self) -> str:
        ...
        """
        return "DATEDIFF({{ unit }}, {{ field1 }}, {{ field2 }})"
    ...
    def convert_to_unix_timestamp_func_template(self) -> str:
        ...
        """
        return "DATEDIFF_BIG(SECOND, '1970-01-01', {{ field }})"
    ...
    def get_approx_quantiles_func_template(self) -> str:
        ...
        """
        return "APPROX_PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY {{ field }})"
    ...
    def get_approx_percentile_func_template(self) -> str:
        ...
        """
        return "APPROX_PERCENTILE_CONT({{ percentile }}) WITHIN GROUP (ORDER BY {{ field }})"
    ...
    def get_regexp_expression_template(self) -> str:
        ...
        """
        pass  # T-SQL has no native regex support
    ...
    def get_regexp_count_expression_template(self) -> str:
        ...
        """
        pass  # T-SQL has no native regex count support
    ...
    def array_expr_template(self) -> str:
        ...
        """
        pass  # T-SQL has no native array type
    ...
    def get_is_timestamp_expression_template(self) -> str:
        ...
        """
        return "TRY_CAST({{ field }} AS DATETIME2) IS NOT NULL"
    ...
    def get_not_is_timestamp_expression_template(self) -> str:
        ...
        """
        return "TRY_CAST({{ field }} AS DATETIME2) IS NULL"
    ...
    def unpivot_template(self) -> str:
        ...
        """
        return "SELECT {{ name_column }}, {{ value_column }} FROM ({{ query }}) AS _src UNPIVOT ({{ value_column }} FOR {{ name_column }} IN ({{ columns | join(', ') }})) AS _unpivoted"
