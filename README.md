...
- `manifest.json` — unique `connector_type` identifier
...
- **connector_type** — unique identifier for this connector (from `manifest.json`)
...
custom-connector-setup/
  connectors/
    ...
    <your-database>/                      # Created by you (one directory per connector)
      ...
      manifest.json                       # {"connector_type": "custom-connector-xxx", "name": "..."}
